...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = db()->prepare('INSERT INTO final_outputs (application_id, signature_file_path, resolution_file_path, endorsement_number, uploaded_by) VALUES (?, ?, ?, ?, ?)');
    ...
    notify_user((int)$application['landlord_id'], $applicationId, 'Application Approved', 'Congratulations! Your application (' . $application['registry_number'] . ') has been officially approved. The endorsement/resolution has been uploaded. You may now log in to view the final output.');
