...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($decision === 'APPROVED') {
        advance_application($applicationId, 'DELIBERATION', 13);
    } else {
        advance_application($applicationId, $decision, 12);
    }
    ...
    $_SESSION['flash_success'] = 'Decision submitted. Landlord notification is queued.';
    redirect('twg/voting.php?id=' . $applicationId);
}
    ...
    <div class="col-lg-4">
        <div class="gov-card p-3">
            ...
            <div class="list-group">
                ...
                <?php endforeach; ?>
                <?php if (!$applications): ?><div class="text-secondary small">No applications are under deliberation.</div><?php endif; ?>
            </div>
        </div>
    </div>
    <div class="col-lg-8">
